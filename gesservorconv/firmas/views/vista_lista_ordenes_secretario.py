...
class VistaListaOrdenesSecretario(
    MixinAccesoRequerido,
    UserPassesTestMixin,
    TemplateView
):
    paginate_by: int = 10
    template_name: str = "firmas/listar_ordenes_secretario.html"
        ...
        if request.htmx:
            ...
            if not tipo or tipo == "curso":
                ...
                if tipo == "curso":
                    return render(
                        request,
                        "parciales/_lista_ordenes_en_curso_secretario.html",
            ...
            if not tipo or tipo == "suspendido":
                ...
                if tipo == "suspendido":
                    return render(
                        request,
                        "parciales/_lista_ordenes_suspendidas_secretario.html",
            ...
            if not tipo or tipo == "cancelado":
                ...
                if tipo == "cancelado":
                    return render(
                        request,
                        "parciales/_lista_ordenes_canceladas_secretario.html",
                        {"pagina_cancelado": objeto_pagina_cancelado}
                    )
            return render(
                request,
                "parciales/_lista_ordenes_secretario.html",
                {
                    "pagina_curso": objeto_pagina_curso,
                    "pagina_suspendido": objeto_pagina_suspendido,
                    "pagina_cancelado": objeto_pagina_cancelado
