...
class VistaListaOrdenesResponsable(
    MixinAccesoRequerido,
    MixinPermisoRequerido,
    UserPassesTestMixin,
    TemplateView
    ...
    paginate_by: int = 10
    template_name: str = "firmas/listar_ordenes_responsable.html"
        ...
        if request.htmx:
            ...
            if not tipo or tipo == "curso":
                ...
                if tipo == "curso":
                    return render(
                        request,
                        "parciales/_lista_ordenes_en_curso_responsable.html",
            ...
            if not tipo or tipo == "suspendido":
                ...
                if tipo == "suspendido":
                    return render(
                        request,
                        "parciales/_lista_ordenes_suspendidas_responsable.html",
            ...
            if not tipo or tipo == "cancelado":
                ...
                if tipo == "cancelado":
                    return render(
                        request,
                        "parciales/_lista_ordenes_canceladas_responsable.html",
                        {"pagina_cancelado": objeto_pagina_cancelado}
                    )
            return render(
                request,
                "parciales/_lista_ordenes_responsable.html",
                {
                    "pagina_curso": objeto_pagina_curso,
                    "pagina_suspendido": objeto_pagina_suspendido,
                    "pagina_cancelado": objeto_pagina_cancelado
