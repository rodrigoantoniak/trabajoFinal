...
class VistaListaConveniosComitente(
    MixinAccesoRequerido,
    MixinPermisoRequerido,
    UserPassesTestMixin,
    TemplateView
    ...
    paginate_by: int = 10
    template_name: str = "firmas/listar_convenios_comitente.html"
    ...
    def get_queryset(self: Self) -> QuerySet[Convenio]:
        '''
        Se filtra los convenios que pertenezcan al comitente
        '''
        ...
        if request.htmx:
            ...
            if not tipo or tipo == "curso":
                ...
                if tipo == "curso":
                    return render(
                        request,
                        "parciales/_lista_convenios_en_curso_comitente.html",
            ...
            if not tipo or tipo == "suspendido":
                ...
                if tipo == "suspendido":
                    return render(
                        request,
                        "parciales/_lista_convenios_suspendidos_comitente.html",
            ...
            if not tipo or tipo == "cancelado":
                ...
                if tipo == "cancelado":
                    return render(
                        request,
                        "parciales/_lista_convenios_cancelados_comitente.html",
                        {"pagina_cancelado": objeto_pagina_cancelado}
                    )
            return render(
                request,
                "parciales/_lista_convenios_comitente.html",
                {
                    "pagina_curso": objeto_pagina_curso,
                    "pagina_suspendido": objeto_pagina_suspendido,
                    "pagina_cancelado": objeto_pagina_cancelado
