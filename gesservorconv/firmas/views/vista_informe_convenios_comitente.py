...
class VistaInformeConveniosComitente(
    MixinAccesoRequerido,
    MixinPermisoRequerido,
    UserPassesTestMixin,
    TemplateView
):
    template_name: str = 'firmas/informe_convenios_comitente.html'
    ...
    def get(
        ...
        if request.htmx:
            ...
            if int(grupos) > 25:
                ...
                return render(
                    request,
                    'parciales/_estadistica_informe_convenios_comitente.html',
                    contexto
                )
